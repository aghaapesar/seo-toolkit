...
### Technical SEO Audit — Persian PDF (v4.8.0 – v4.9.0)
...
4. The tool auto-detects the CMS/stack (WordPress, Shopify, Next.js, Laravel, …) and adds platform-specific solutions to each issue.
5. Watch progress on the task page; when done, download the **Persian PDF report** and JSON data.
6. Previous reports are archived under `projects/{slug}/output/technical_audit/`.
